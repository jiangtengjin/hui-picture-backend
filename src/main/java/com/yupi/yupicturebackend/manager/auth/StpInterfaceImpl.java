...
import static com.yupi.yupicturebackend.constants.UserConstant.USER_LOGIN_STATE;
        ...
        if (spaceId == null) {
            ...
            if (spaceId == null) {
                if (picture.getUserId().equals(userId) || userService.isAdmin(loginUser)) {
                    ...
                    // 不是自己的图片，仅可查看
                    return Collections.singletonList(SpaceUserAuthConstant.PICTURE_VIEW);
                }
            }
        }
        // 获取 Space 对象
